...
const profilePhoto = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200'><rect width='100%' height='100%' fill='%23667eea'/><text x='50%' y='54%' text-anchor='middle' dominant-baseline='middle' font-size='72' fill='white' font-family='Arial'>RK</text></svg>";
